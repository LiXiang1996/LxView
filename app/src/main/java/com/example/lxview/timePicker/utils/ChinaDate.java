...
public class ChinaDate {
     ...
     * <lunarInfo 数组值的计算原理>
     *
     * <p>0x代表十六进制，后面的五位数是十六进制数。 举个例子: 1980年的数据是 0x095b0 二进制: 0000 1001 0101 1011 0000 1-4:
     * 表示当年是否为闰年，是的话为1，否则为0。 5-16: 为除了闰月外的正常月份是大月还是小月，1为30天，0为29天。 注意: 从1月到12月对应的是第16位到第5位。 17-20:
     * 非闰年为0，大于0表示闰月月份，仅当存在闰月的情况下有意义。
     */
    ...
    private static final String[] nStr1 =
            new String[] {"", "正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊"};
    ...
    private static final String[] nStrus =
            new String[] {
     ...
     * @return String of Ganzhi: 甲子年 甲乙丙丁戊己庚辛壬癸 子丑寅卯辰巳无为申酉戌亥
     */
