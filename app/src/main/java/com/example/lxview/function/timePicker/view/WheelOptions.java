package com.example.lxview.function.timePicker.view;
...
import com.example.lxview.function.timePicker.adapter.ArrayWheelAdapter;
import com.example.lxview.function.timePicker.listener.OnOptionsSelectChangeListener;
...
public class WheelOptions<T> {
    ...
    public void setPicker(
            List<T> options1Items, List<List<T>> options2Items, List<List<List<T>>> options3Items) {
                    ...
                    public void onItemSelected(int index) {
                        ...
                        if (mOptions2Items == null) { // 只有1级联动数据
                            ...
                            if (!isRestoreItem) {
                                ...
                                opt2Select =
                                        opt2Select >= mOptions2Items.get(index).size() - 1
                                                ? mOptions2Items.get(index).size() - 1
                                                : opt2Select;
                            }
                ...
                new OnItemSelectedListener() {
                    ...
                    public void onItemSelected(int index) {
                        if (mOptions3Items != null) {
                            ...
                            opt1Select =
                                    opt1Select >= mOptions3Items.size() - 1
                                            ? mOptions3Items.size() - 1
                                            : opt1Select;
                            index =
                                    index >= mOptions2Items.get(opt1Select).size() - 1
                                            ? mOptions2Items.get(opt1Select).size() - 1
                                            : index;
                            int opt3 = 0;
                            if (!isRestoreItem) {
                                ...
                                opt3 =
                                        wv_option3.getCurrentItem()
                                                        >= mOptions3Items
                                                                        ...
                                                                        .size()
                                                                - 1
                                                ? mOptions3Items.get(opt1Select).get(index).size()
                                                        - 1
                                                : wv_option3.getCurrentItem();
                            }
                            ...
                            if (optionsSelectChangeListener != null) {
                                optionsSelectChangeListener.onOptionsSelectChanged(
                                        wv_option1.getCurrentItem(), index, opt3);
                            }
                        } else { // 只有2级联动数据，滑动第2项回调
                            if (optionsSelectChangeListener != null) {
                                optionsSelectChangeListener.onOptionsSelectChanged(
                                        wv_option1.getCurrentItem(), index, 0);
                            }
                        }
                    }
                };
        ...
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setOnItemSelectedListener(
                    new OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(int index) {
                            optionsSelectChangeListener.onOptionsSelectChanged(
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setOnItemSelectedListener(
                    new OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(int index) {
                            optionsSelectChangeListener.onOptionsSelectChanged(
        ...
        if (options2Items == null) {
            ...
            wv_option2.setVisibility(View.VISIBLE);
            if (optionsSelectChangeListener != null) {
                wv_option2.setOnItemSelectedListener(
                        new OnItemSelectedListener() {
                            @Override
                            public void onItemSelected(int index) {
                                optionsSelectChangeListener.onOptionsSelectChanged(
    ...
    public int[] getCurrentItems() {
        ...
        if (mOptions2Items != null && mOptions2Items.size() > 0) { // 非空判断
            currentItems[1] =
                    wv_option2.getCurrentItem() > (mOptions2Items.get(currentItems[0]).size() - 1)
                            ? 0
                            : wv_option2.getCurrentItem();
        } else {
    ...
    private void itemSelected(int opt1Select, int opt2Select, int opt3Select) {
        ...
        if (mOptions3Items != null) {
            wv_option3.setAdapter(
                    new ArrayWheelAdapter(mOptions3Items.get(opt1Select).get(opt2Select)));
    ...
    public void setOptionsSelectChangeListener(
