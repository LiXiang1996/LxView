...
import com.example.lxview.function.timePicker.listener.OnDismissListener;
import com.example.lxview.function.timePicker.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            // 如果是对话框模式
            dialogView =
                    (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview, null, false);
            // 设置界面的背景为透明
