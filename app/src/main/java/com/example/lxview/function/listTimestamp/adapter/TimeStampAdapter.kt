package com.example.lxview.function.listTimestamp.adapter
...
import com.example.lxview.function.listTimestamp.ImMessageDecoration
...
class TimeStampAdapter(layoutResId: Int,recyclerView: RecyclerView) :
    ...
    override fun getTextSize(): Int {
        return SizeUtils.sp2px(this.mContext,10f)
    }

    override fun getTextColor(): Int {
        return this.mContext.resources.getColor(R.color.black)
    }
