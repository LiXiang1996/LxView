...
import com.example.lxview.function.timePicker.listener.OnTimeSelectChangeListener;
...
public class TimePickerBuilder {
    ...
    /**
     * new boolean[]{true, true, true, false, false, false} control the
     * "year","month","day","hours","minutes","seconds " display or hide.
    ...
    /** 设置起始时间 因为系统Calendar的月份是从0-11的,所以如果是调用Calendar的set方法来设置时间,月份的范围也要是从0-11 */
    ...
    public TimePickerBuilder setLabel(
            String label_year,
            String label_month,
            String label_day,
            String label_hours,
     ...
     * @return
     */
    public TimePickerBuilder setTextXOffset(
            int x_offset_year,
            int x_offset_month,
            int x_offset_day,
            int x_offset_hours,
