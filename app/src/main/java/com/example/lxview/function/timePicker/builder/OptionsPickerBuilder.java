package com.example.lxview.function.timePicker.builder;
...
import com.example.lxview.function.timePicker.listener.CustomListener;
import com.example.lxview.function.timePicker.listener.OnOptionsSelectChangeListener;
import com.example.lxview.function.timePicker.listener.OnOptionsSelectListener;
import com.example.lxview.function.timePicker.view.OptionsPickerView;
...
public class OptionsPickerBuilder {
    ...
    /**
     * ViewGroup 类型 设置PickerView的显示容器
     *
    ...
    public OptionsPickerBuilder setTextXOffset(
            int xoffset_one, int xoffset_two, int xoffset_three) {
     ...
     * @return
     */
    public OptionsPickerBuilder setOptionsSelectChangeListener(
