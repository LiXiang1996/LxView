...
/**
 * 自定义PopWindow类，封装了PopWindow的一些常用属性，用Builder模式支持链式调用 Created by zhouwei on 16/11/28.
 */
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder setView(View view, int sua) {
            if (sua != -1) view.setSystemUiVisibility(sua);
            mCustomPopWindow.mContentView = view;
            mCustomPopWindow.mResLayoutId = -1;
            return this;
        }
